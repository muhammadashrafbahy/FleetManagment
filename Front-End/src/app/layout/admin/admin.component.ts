...
export class AdminComponent implements OnInit {
  ...
  mng:manager  = JSON.parse(this.item);
   comp_field:string=this.mng.comp_field;
   comp_name:string=this.mng.comp_name;
...
/*  @ViewChild('toggleButton') toggle_button: ElementRef;
  ...
  constructor(public menuItems: MenuItems , private route:Router , private srv:ManagerService) {
